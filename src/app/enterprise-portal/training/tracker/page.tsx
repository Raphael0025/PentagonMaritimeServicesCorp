...
export default function TrackerPage(){
    ...
    useEffect(() => {
        const fetchData = () => {
            ...
            const traineeChargeCount = allTrainData?.filter(t => t.accountType === 0).length;
            const companyChargeCount = allTrainData?.filter(t => t.accountType === 1).length;
        ...
        fetchData()
    },[monthSelected, yearSelected, allTrainingData, filterCourse, filterInstructor, filterMode, filterCompany])
