...
import { BatchedDated, UnBatchedDated, BDTracker } from '@/Components/Page/Training/CertificationMonitoring'
        ...
        const fetchData = () => {
            ...
            const allTrainData = allTrainingData && allTrainingData
                .filter((t) => {
                    ...
                    const regMonth = Number(splitRegNo[1])
                    
                    return regYear === yearSelected && regMonth === monthSelected + 1
                })
                .filter(t => {
