...
export default function Page(){
    ...
    const handleUploadImg = async () => {
        try{
            ...
            handleToast(`Failed to change Trainee's Attachment.`, `Trainee's attachment file was not successfully updated. Please issue this to the IT department.`, 5000, 'error')
        } finally {
            setLoading(false)
        }
    }
