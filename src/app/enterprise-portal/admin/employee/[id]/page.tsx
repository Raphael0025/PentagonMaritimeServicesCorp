...
export default function Page({params}: PageProps){
    ...
    let padRef = useRef<SignatureCanvas>(null) // State to store candidate details
    ...
    const handleSaveData = async () => {
        ...
        .then(() => {
            toast({
                title: `Employee Information has been updated successfully by ${actor}`,
                position: 'top-right',
                variant: 'left-accent',
                status: 'success',
            })
        ...
        .finally(() => {
            setLoading(false)
            router.push('/enterprise-portal/admin/employee')
        })
    }
                    ...
                    <Box className='flex flex-col space-y-3'>
                        ...
                        <Box className='flex justify-between space-x-5'>
                            <Box className='w-full justify-center flex flex-col'>
                                ...
                                <FormControl>
                                    <Input id='contact_person' fontSize='sm' onChange={handleChange} variant='unstyled' value={company_staff.contact_person} />
                                </FormControl>
                            </Box>
                            <Box className='w-1/2 justify-center flex flex-col'>
                                <Text fontSize='xs' color='#a1a1a1' >Contact No.:</Text>
                                <FormControl>
                                    <Input id='emergency_contact' fontSize='sm' onChange={handleChange} variant='unstyled' value={company_staff.emergency_contact} />
                                </FormControl>
                            </Box>
                            <Box className='w-1/2 justify-center flex flex-col'>
                                <Text fontSize='xs' color='#a1a1a1' >Relationship:</Text>
                                <FormControl>
                                    <Input id='relationship' fontSize='sm' onChange={handleChange} variant='unstyled' value={company_staff.relationship} />
                                </FormControl>
                            </Box>
                            <Box className='w-full justify-center flex flex-col'>
                                <Text fontSize='xs' color='#a1a1a1' >Address:</Text>
                                <FormControl>
                                    <Input id='contact_address' fontSize='sm' onChange={handleChange} variant='unstyled' value={company_staff.contact_address} />
                                </FormControl>
                            </Box>
                        </Box>
                    </Box>
                            ...
                            <Table size='sm'>
                                <Thead>
                                    <Tr>
                                        ...
                                        <Th style={{width: '50%'}}><span className='text-xs font-medium'>Inclusive Dates</span></Th>
                                        <Th><span className='text-xs font-medium'>Action</span></Th>
                                    </Tr>
                                </Thead>
                                <Tbody>
