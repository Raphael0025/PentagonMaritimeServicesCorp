...
export async function POST(request: NextRequest) {
  try {
    const { to, subject, text, last_name, given_name } = await request.json();
    ...
    await transporter.sendMail({
      from: `Survey Confirmation. <${process.env.EMAIL}>`,
                ...
                <body>
                    <div className="outer-container">
                        <div class="container">
                            ...
                            <div class="content">
                                <p>This is to confirm that your survey has been submitted.</p>
                                <p>Thank you very much for your valuable information. We aim to be  better next time.</p>
