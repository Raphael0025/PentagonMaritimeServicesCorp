...
import animationData from './ComingSoon.json' // Import the JSON animation file
...
export default function ShipOnPhone(){
    ...
    return (
        <>{/* Container for the Lottie animation */}
            <div id="lottie-container" style={{ width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}></div>
        </>
    );
}