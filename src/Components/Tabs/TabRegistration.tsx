...
export default function TabRegistration() {
    ...
    return(
        <nav className='flex space-x-6'>
            ...
            <Link  className={`p-2 px-4 transition ease-in-out duration-300 ${ currentTab === 'batch' ? 'border-tab-active font-semibold text-sky-600' : 'border-tab-inactive font-normal text-gray-400'} `} href='/enterprise-portal/registration/batches' onClick={() => {handleClick('batch')}}>Batch Records</Link>
