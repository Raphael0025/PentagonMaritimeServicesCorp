        ...
        <Modal isOpen={isOpenScope} onClose={onCloseScope}>
            ...
            <ModalContent>
                ...
                <ModalFooter gap='2'>
                    ...
                    <Button onClick={() => {onOpenTrainingDate();}} colorScheme='blue' isLoading={activeBtn === training_id} loadingText='Loading...' bgColor='blue.900' shadow='md' w='100%'>BackDated</Button>
                </ModalFooter>
            </ModalContent>
        </Modal>
