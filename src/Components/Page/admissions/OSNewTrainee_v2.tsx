        ...
        try{
            ...
            if(traineeID !== null){
                ...
                if(ccArr.length !== 0){
                    ...
                    regCCID = await addRegistrationDetails(traineeID, fee, 1, 0, 1, trainee.marketing)
                    for(const course of ccArr){
                        try{
                            if(regCCID){
                ...
                if(crewArr.length !== 0){
                    ...
                    regCrewID = await addRegistrationDetails(traineeID, fee, 1, 0, 1, trainee.marketing)
                    for(const course of crewArr){
                        try{
                            if(regCrewID){
