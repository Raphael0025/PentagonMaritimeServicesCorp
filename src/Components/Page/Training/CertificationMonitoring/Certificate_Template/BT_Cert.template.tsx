...
export default function BT_Cert({selectedTrainings, trainingID, searchTerm}: ComponentProps){
    ...
    return(
        ...
        return trainingID.includes(t.id)}).map((training: any, index: number) => {
            ...
            const issuedDate = formatNextDay(training.end_date, getYear || 0)
            ...
            <Box w='216mm' h='279mm' position='relative' display='flex' flexDir='column' p='0' justifyContent='center' alignItems='center' >
                <Box pt='10' w='216mm' h='279mm' position='relative' zIndex={2} display='flex' fontSize='12pt' fontWeight='normal'  flexDir='column' alignItems='center'>
                    ...
                    <Box pt='12' pr='4' pb='12' display='flex' justifyContent='end' w='95%'>
                    ...
                    <Box w='100%' h='60%' display='flex' flexDir='column' alignItems='center' justifyContent='center' gap='0'>
                        <Text pt='8' fontWeight='bold' fontSize='26pt'>Certificate of Training Completion</Text>
                        <Text pt='3' fontSize='12pt'>This certificate is issued to</Text>
                        <Text py='3' fontWeight='bold' fontSize='20pt' textTransform='uppercase'>{`${trainee.first_name} ${trainee.middle_name} ${trainee.last_name}`}</Text>
                        <Text fontSize='12pt'>for having successfully completed the</Text>
                        ...
                        <Box display='flex' flexDir='column' justifyContent='center'>
                            ...
                            >
                                {`in accordance with Regulation VI/1 of the STCW Convention, 1978, as amended`}
                            </Box>
                            <Box w='530px'
                                mt='5'
                                mx='auto'
                                ...
                                fontFamily='Arial, Helvetica, sans-serif'
                            >
                                {`conducted from ${trainingDate}, as approved by the Maritime Industry Authority (MARINA) pursuant to Republic Act No. 10635, and in compliance with MARINA Memorandum Circulars No. SC-2022-05 and SC-2021-09, after having been assessed on ${issuedDate} by the accredited Assessor based on the approved assessment methods and criteria.`}
                                {/* <Text>
                                    {` SC-2021-09, after having been assessed on ${issuedDate} by the accredited Assessor based on the approved assessment methods and criteria`}
                                </Text> */}
                            </Box>
                        </Box>
                        ...
                        />
                        <Box pt='20' pb='5' display='flex' alignItems='end' w='85%'>
                            <Box w='40%' position='relative' display='flex' flexDirection='column' justifyContent={'center'} alignItems='center' >
                                {(() => {
                                    ...
                                    return(
                                        <>
                                            <Box position='absolute' top='-42px' left='-5%' transform="translateX(15%)" zIndex={2} >
                                                <ChakraImage src={eSignSrc} w='80%' h='80%' alt='signature' />
                                            </Box>
                                            <Box borderTop='1px solid black' w='90%' />
                                            <Text position='relative' textAlign='center' zIndex={1} w='100%' pt='1' fontSize='12pt' fontWeight='bolder'>
                                                {(() => {
                            ...
                            <Box w='20%' pb='9' display='flex' flexDirection='column' justifyContent={'center'} alignItems='center'>
                            </Box>
                            <Box w='40%' position='relative' display='flex' flexDirection='column' justifyContent={'center'} alignItems='center' >
                                {(() => {
                                    ...
                                    return(
                                        <>
                                            <Box position='absolute' top='-55px' left='6%' w='200px' h='100px' transform="translateX(10%)" zIndex={2} >
                                                <NextImage src={eSignSrc} fill priority style={{ objectFit: 'contain'}} alt='signature' />
                                            </Box>
                                            <Box borderTop='1px solid black' w='90%' /> 
                                            <Text position='relative' textAlign='center' zIndex={1} w='100%' pt='1' fontSize='12pt' fontWeight='bold'>
                                                {(() => {
                                                    if (!ins) return 'No Instructor';
                    ...
                    <Box display='flex' pt='0' alignItems='center' justifyContent='center' gap='3'>
