...
export default function SDSDCertTemplate({selectedTrainings, trainingID, searchTerm}: ComponentProps){
        ...
        return trainingID.includes(t.id)}).map((training: any, index: number) => {
            ...
            <Box w='216mm' h='279mm' position='relative' display='flex' flexDir='column' p='0' justifyContent='center' alignItems='center' >
                <Box pt='14' w='216mm' h='279mm' position='relative' zIndex={2} display='flex' fontSize='12pt' fontWeight='normal'  flexDir='column' alignItems='center'>
                    <ChakraImage src={'/certificateHeader_SDSD.png'} alt='header image' w='7.05in' h='0.75in'  objectFit='cover'/>
                    ...
                    <Box w='100%' h='85%' display='flex' flexDir='column' alignItems='center' justifyContent='center' gap='0'>
                        ...
                        <Text pt='4' fontWeight='bold' fontSize='20pt' textTransform='uppercase'>{`${trainee.first_name} ${trainee.middle_name} ${trainee.last_name}`}</Text>
                        <Text pt='2'>for having successfully completed the training in</Text>
                        <Text fontSize='12pt' w='70%' mt='6' fontFamily='Arial, Helvetica, sans-serif' textAlign='center' fontWeight='bold'>
                        ...
                        <Box display='flex' flexDir='column' justifyContent='center'>
                            ...
                            >
                                {`in compliance with Regulation VI/6, Section A-VI/6, Table A-VI/6-1 and Table A-VI/6-2 of the STCW Convention, as amended`}
                            </Box>
                            <Box w='615px'
                                mt='5'
                                mx='auto'
                                ...
                                fontFamily='Arial, Helvetica, sans-serif'
                            >
                                {`Conducted on ${trainingDate}, as approved by the Maritime Industry Authority pursuant to the provisions of Republic Act No. 10635, MARINA Circular No.2013-01, STCW Circular No. 2018-02 and STCW Advisory 2019-05 and after having been assessed by the Accredited Assessor in accordance with the approved methods and criteria.`}
                            </Box>
                        </Box>
