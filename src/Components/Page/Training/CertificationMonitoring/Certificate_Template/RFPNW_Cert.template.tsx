...
export default function RFPNW_CERT({selectedTrainings, trainingID, searchTerm}: ComponentProps){
                ...
                <Box pt='14' w='216mm' h='279mm' position='relative' zIndex={2} display='flex' fontSize='12pt' fontWeight='normal'  flexDir='column' alignItems='center'>
                    ...
                    <Box w='100%' h='60%' display='flex' flexDir='column' alignItems='center' justifyContent='center' gap='0'>
                        ...
                        >
                            ...
                            >
                                {`serving on seagoing ship of 500 gross tonnage or more`}
                            </Box>
                            <Box w='615px'
                                mt='5'
                                mx='auto'
                                ...
                                fontFamily='Arial, Helvetica, sans-serif'
                            >
                                {`In compliance with Regulation II/4, paragraph 2.2, Section A-II/4, Table A-II/4 of the 1978 STCW Convention,  as amended.`}
                            </Box>
                            <Box w='615px'
                                mt='5'
                                mx='auto'
                                ...
                                fontFamily='Arial, Helvetica, sans-serif'
                            >
                                {`Conducted from ${trainingDate}, as approved by the Maritime Industry Authority pursuant to the provisions of Republic Act No. 10635, MARINA Circular No. SC-2021-09, MARINA Circular No. SC-2022-05 and MARINA Circular No. SC-2023-03 and after having been assessed by the accredited Assessor in accordance with the approved methods and criteria.`}
                            </Box>
                        </Box>
