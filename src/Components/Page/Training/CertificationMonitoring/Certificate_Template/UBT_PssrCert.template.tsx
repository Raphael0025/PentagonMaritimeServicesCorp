...
export default function UBT_PssrCert({selectedTrainings, trainingID, searchTerm}: ComponentProps){
            ...
            <Box w='216mm' h='279mm' position='relative' display='flex' flexDir='column' p='0' justifyContent='center' alignItems='center' >
                <Box pt='10' w='216mm' h='279mm' position='relative' zIndex={2} display='flex' fontSize='12pt' fontWeight='normal'  flexDir='column' alignItems='center'>
                    ...
                    <Box w='100%' h='60%' display='flex' flexDir='column' alignItems='center' justifyContent='center' gap='0'>
                        ...
                        <Text>for having successfully completed the</Text>
                        ...
                        >
                            ...
                            >
                                {`in accordance with the STCW Convention, 1978, as amended, and in compliance with the amendments to Table A-VI/1-4 of Section A-VI/1 of the STCW Code, as adopted under Resolution MSC.560 (108) of the Maritime Safety Committee.`}
                            </Box>
                            <Box w='615px'
                                mt='5'
                                mx='auto'
