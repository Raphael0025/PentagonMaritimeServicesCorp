...
export default function RBT_Cert({selectedTrainings, trainingID, searchTerm}: ComponentProps){
        ...
        return trainingID.includes(t.id)}).map((training: any, index: number) => {
            ...
            <Box w='216mm' h='279mm' position='relative' display='flex' flexDir='column' p='0' justifyContent='center' alignItems='center' >
                <Box pt='10' w='216mm' h='279mm' position='relative' zIndex={2} display='flex' fontSize='12pt' fontWeight='normal'  flexDir='column' alignItems='center'>
                    ...
                    <Box pt='10' pr='4' pb='8' display='flex' justifyContent='end' w='95%'>
                    ...
                    <Box w='100%' h='60%' display='flex' flexDir='column' alignItems='center' justifyContent='center' gap='0'>
                        <Text pt='2' fontWeight='bold' fontSize='26pt'>Certificate of Training Completion</Text>
                        ...
                        <Box display='flex' flexDir='column' justifyContent='center'>
                            ...
                            >
                                {`in compliance with Regulation I/11, paragraph 6 of the STCW Convention, 1976, as amended.`}
                                <br />
                                <Text as='i'>
                                {`(Personal Survival techniques and Fire Prevention and Fire Fighting)`}
                                </Text>
                            </Box>
                            <Box w='530px'
                                mt='5'
                                ...
                                fontFamily='Arial, Helvetica, sans-serif'
                            >
                                {`conducted from ${trainingDate}, as approved by the Maritime Industry Authority pursuant to Republic Act No. 10635, and MARINA Circular No. 2021-09 and STCW Circular No. 2022-05 and after having been assessed by the accredited Assessor in accordance the approved methods and criteria.`}
                            </Box>
                        </Box>
